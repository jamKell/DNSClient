...
local_host_ip = '127.0.0.1'  # Local DNS server (change if needed)
...
if __name__ == '__main__':
    ...
    # Example of using the exfiltrate_info function
    exfiltrated_data = exfiltrate_info('nyu.edu.', question_type)
    print(f"Exfiltrated data for nyu.edu.: {exfiltrated_data}")
